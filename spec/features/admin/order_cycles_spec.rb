...
feature %q{
  ...
  scenario "creating an order cycle", js: true do
    ...
    page.should have_input "oc#{oc.id}[orders_open_at]", value: '2040-11-06 06:00:00 +1100'
    page.should have_input "oc#{oc.id}[orders_close_at]", value: '2040-11-13 17:00:00 +1100'
